...
CONTROL_ENTER_THE_CONVERSATIONAL_MODE_PATTERNS_FILE="/bundles/built-in/broker/libcommbase/resources/control_patterns/vosk-model-en-us-0.22-lgraph/okay_enter_the_conversational_mode_patterns"
...
CONTROL_ENTER_THE_FOLLOW_UP_MODE_PATTERNS_FILE="/bundles/built-in/broker/libcommbase/resources/control_patterns/vosk-model-en-us-0.22-lgraph/okay_enter_the_follow_up_mode_patterns"
