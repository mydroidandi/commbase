...
AI_CHATBOT_STRING="$TODO: New git repo based on the script terminal_chatgpt"
UNKNOWN_COMMAND_AI_CHATBOT_WORDS_LIMIT="35"
TRAINED_AI_CHATBOT_CAN_RUN_SKILLS_ON="False"
TRAINED_AI_CHATBOT_STRING="$TODO: New git repo based on the script terminal_chatgpt"
UNKNOWN_COMMAND_TRAINED_AI_CHATBOT_WORDS_LIMIT="35"
