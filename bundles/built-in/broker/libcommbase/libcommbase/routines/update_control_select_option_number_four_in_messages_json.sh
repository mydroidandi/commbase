...
# update_control_select_option_number_four_in_messages_json.sh
# Updates the control select_option_number_four in data/.messages.json and sends the
# messages request through commbase-data-exchange client.
update_control_select_option_number_four_in_messages_json() {
  # Configuration file
  ...
  new_control_value="select_option_number_four"
...
# Call update_control_select_option_number_four_in_messages_json if the script is run directly (not sourced)
