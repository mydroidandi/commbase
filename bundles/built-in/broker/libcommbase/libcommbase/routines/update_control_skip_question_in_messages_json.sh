...
# update_control_skip_question_in_messages_json.sh
# Updates the control skip_question in data/.messages.json and sends the
# messages request through commbase-data-exchange client.
update_control_skip_question_in_messages_json() {
  # Configuration file
  ...
  new_control_value="skip_question"
...
# Call update_control_skip_question_in_messages_json if the script is run directly (not sourced)
