...
# update_control_enter_the_normal_mode_in_messages_json.sh
# Updates the control enter_the_normal_mode in data/.messages.json and sends the
# messages request through commbase-data-exchange client.
update_control_enter_the_normal_mode_in_messages_json() {
  # Configuration file
  ...
  new_control_value="enter_the_normal_mode"
...
# Call update_control_enter_the_normal_mode_in_messages_json if the script is run directly (not sourced)
