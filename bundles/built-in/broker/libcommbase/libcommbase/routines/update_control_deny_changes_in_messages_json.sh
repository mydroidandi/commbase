...
# update_control_deny_changes_in_messages_json.sh
# Updates the control deny_changes in data/.messages.json and sends the
# messages request through commbase-data-exchange client.
update_control_deny_changes_in_messages_json() {
  # Configuration file
  ...
  new_control_value="deny_changes"
...
# Call update_control_deny_changes_in_messages_json if the script is run directly (not sourced)
