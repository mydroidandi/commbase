...
# update_control_request_the_current_mode_in_messages_json.sh
# Updates the control request_the_current_mode in data/.messages.json and sends the
# messages request through commbase-data-exchange client.
update_control_request_the_current_mode_in_messages_json() {
  # Configuration file
  ...
  new_control_value="request_the_current_mode"
...
# Call update_control_request_the_current_mode_in_messages_json if the script is run directly (not sourced)
