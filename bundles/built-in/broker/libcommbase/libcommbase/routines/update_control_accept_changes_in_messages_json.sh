...
# update_control_accept_changes_in_messages_json.sh
# Updates the control accept_changes in data/.messages.json and sends the
# messages request through commbase-data-exchange client.
update_control_accept_changes_in_messages_json() {
  # Configuration file
  ...
  new_control_value="accept_changes"
...
# Call update_control_accept_changes_in_messages_json if the script is run directly (not sourced)
