...
(echo "Hostname to the command hostname:" "$MY_HOST_NAME")
(echo "Hostname to the command hostname:" "$MY_HOST_NAME" >> $LOG_FILE)
(echo "Hostname in the environment file:" "$HOSTNAME")
(echo "Hostname in the environment file:" "$HOSTNAME" >> $LOG_FILE)
