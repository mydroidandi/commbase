...
(date >> $LOG_FILE)
(echo "Localhost IP address to the command hostname:" "$MY_HOST_IP_ADDRESS")
(echo "Localhost IP address to the command hostname:" "$MY_HOST_IP_ADDRESS" >> $LOG_FILE)
(echo "Localhost IP address in the environment file:" "$HOST_IP_ADDRESS")
(echo "Localhost IP address in the environment file:" "$HOST_IP_ADDRESS" >> $LOG_FILE)
(echo "My hostname to the command hostname:" "$MY_HOST_NAME")
(echo "My hostname to the command hostname:" "$MY_HOST_NAME" >> $LOG_FILE)
(echo "My hostname in the environment file:" "$HOSTNAME")
(echo "My hostname in the environment file:" "$HOSTNAME" >> $LOG_FILE)
