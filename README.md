...
<img alt="Commbase" src="/assets/docs/images/cover.png?raw=true" width="584" height="326" />
...
<a href="./bundles/commbase-data-exchange/">
    <img align="center" alt="commbase-data-exchange" width="5%" src="./bundles/commbase-data-exchange/commbase-data-exchange.jpg"/>
</a>
...
<a href="./bundles/commbase-genai-llm-google-gemini-p/">
    <img align="center" alt="commbase-genai-llm-google-gemini-p" width="5%" src="./bundles/commbase-genai-llm-google-gemini-p/commbase-genai-llm-google-gemini-p.jpg"/>
</a>
...
<a href="./bundles/commbase-genai-llm-meta-llama-p/">
    <img align="center" alt="commbase-genai-llm-meta-llama-p" width="5%" src="./bundles/commbase-genai-llm-meta-llama-p/commbase-genai-llm-meta-llama-p.jpg"/>
</a>
...
<a href="./bundles/commbase-genai-llm-openai-gpt-p/">
    <img align="center" alt="commbase-genai-llm-openai-gpt-p" width="5%" src="./bundles/commbase-genai-llm-openai-gpt-p/commbase-genai-llm-openai-gpt-p.jpg"/>
</a>
...
<a href="./bundles/commbase-genai-slm-ollama-phi3-mini-memory/">
    <img align="center" alt="commbase-genai-slm-ollama-phi3-mini-memory" width="5%" src="./bundles/commbase-genai-slm-ollama-phi3-mini-memory/commbase-genai-slm-ollama-phi3-mini-memory.jpg"/>
</a>
...
<a href="./bundles/commbase-recorder-transmitter-b/">
    <img align="center" alt="commbase-recorder-transmitter-b" width="5%" src="./bundles/commbase-recorder-transmitter-b/commbase-recorder-transmitter-b.png"/>
</a>
...
<a href="./bundles/commbase-recorder-transmitter-s/">
    <img align="center" alt="commbase-recorder-transmitter-s" width="5%" src="./bundles/commbase-recorder-transmitter-s/commbase-recorder-transmitter-s.png"/>
</a>
...
<a href="./bundles/commbase-stt-whisper-proactive-p/">
    <img align="center" alt="commbase-stt-whisper-proactive-p" width="5%" src="./bundles/commbase-stt-whisper-proactive-p/commbase-stt-whisper-proactive-p.jpg"/>
</a>
...
<a href="./bundles/commbase-stt-whisper-reactive-p/">
    <img align="center" alt="commbase-stt-whisper-reactive-p" width="5%" src="./bundles/commbase-stt-whisper-reactive-p/commbase-stt-whisper-reactive-p.jpg"/>
</a>
...
<a href="./bundles/libcommbase">
    <img align="center" alt="libcommbase" width="5%" src="./bundles/libcommbase/libcommbase.jpg"/>
</a>
  ...
  <tr>
    <td align="center">
      <a href="https://backdropbuild.com/builds/v5/commbase-xfz3">
        <img alt="BackdropBuild Contest" width="150" src="./assets/docs/images/backdropbuild-v4-contest-build.png" />
      </a>
      <br/>
    ...
    <td align="center">
      <a href="https://developers.google.com/profile/badges/events/ai/gemini_api_competition">
        <img alt="Gemini API Developer Competition" width="150" src="./assets/docs/images/gemini-api-developer-competition.svg" />
      </a>
      <br/>
  ...
  <tr>
    <td align="center">
      <a href="https://backdropbuild.com">
        <img alt="BackdropBuild" width="50" src="./assets/docs/images/backdropbuild.png" />
      </a>
      <br/>
    ...
    <td align="center">
      <a href="https://vercel.com">
        <img alt="Vercel" width="50" src="./assets/docs/images/vercel.png" />
      </a>
      <br/>
      <sub><b>Vercel</b></sub>
    ...
    <td align="center">
      <a href="https://github.com/">
        <img alt="GitHub" width="50" src="./assets/docs/images/github.png" />
      </a>
      <br/>
      <sub><b>GitHub</b></sub>
    ...
    <td align="center">
      <a href="https://www.pinecone.io/">
        <img alt="Pinecone" width="50" src="./assets/docs/images/pinecone.png" />
      </a>
      <br/>
