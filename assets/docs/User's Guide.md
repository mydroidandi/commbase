...
- **TTS_ENGINE_STRING**:
  ...
  - Possible values: 
    ...
    - `TODO:`: It specifies the TTS engine commbase-tts-pyttsx3.py's executable script and arguments. gTTS (Google Text-to-Speech)is a Python library and CLI tool to interface with Google Translate text-to-speech API.
