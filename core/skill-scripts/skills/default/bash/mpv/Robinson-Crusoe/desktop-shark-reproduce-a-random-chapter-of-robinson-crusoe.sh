...
1)  echo "Reproducing audio #:" $chapter" of" $total
    mpv $COMMBASE/Commbase/mpv/Robinson-Crusoe/crusoe_anew_01_baldwin_64kb.mp3
    ;;
...
3)  echo "Reproducing audio #:" $chapter" of" $total
    mpv $COMMBASE/Commbase/mpv/Robinson-Crusoe/crusoe_anew_03_baldwin_64kb.mp3
   ;;
4)  echo "Reproducing audio #:" $chapter" of" $total
    mpv $COMMBASE/Commbase/mpv/Robinson-Crusoe/crusoe_anew_04_baldwin_64kb.mp3
   ;;
5)  echo "Reproducing audio #:" $chapter" of" $total
    mpv $COMMBASE/Commbase/mpv/Robinson-Crusoe/crusoe_anew_05_baldwin_64kb.mp3
   ;;
6)  echo "Reproducing audio #:" $chapter" of" $total
    mpv $COMMBASE/Commbase/mpv/Robinson-Crusoe/crusoe_anew_06_baldwin_64kb.mp3
   ;;
7)  echo "Reproducing audio #:" $chapter" of" $total
    mpv $COMMBASE/Commbase/mpv/Robinson-Crusoe/crusoe_anew_07_baldwin_64kb.mp3
   ;;
8)  echo "Reproducing audio #:" $chapter" of" $total
    mpv $COMMBASE/Commbase/mpv/Robinson-Crusoe/crusoe_anew_08_baldwin_64kb.mp3
   ;;
9)  echo "Reproducing audio #:" $chapter" of" $total
    mpv $COMMBASE/Commbase/mpv/Robinson-Crusoe/crusoe_anew_09_baldwin_64kb.mp3
   ;;
10)  echo "Reproducing audio #:" $chapter" of" $total
    mpv $COMMBASE/Commbase/mpv/Robinson-Crusoe/crusoe_anew_10_baldwin_64kb.mp3
   ;;
11)  echo "Reproducing audio #:" $chapter" of" $total
    mpv $COMMBASE/Commbase/mpv/Robinson-Crusoe/crusoe_anew_11_baldwin_64kb.mp3
   ;;
12)  echo "Reproducing audio #:" $chapter" of" $total
    mpv $COMMBASE/Commbase/mpv/Robinson-Crusoe/crusoe_anew_12_baldwin_64kb.mp3
   ;;
13)  echo "Reproducing audio #:" $chapter" of" $total
    mpv $COMMBASE/Commbase/mpv/Robinson-Crusoe/crusoe_anew_13_baldwin_64kb.mp3
   ;;
14)  echo "Reproducing audio #:" $chapter" of" $total
    mpv $COMMBASE/Commbase/mpv/Robinson-Crusoe/crusoe_anew_14_baldwin_64kb.mp3
   ;;
15)  echo "Reproducing audio #:" $chapter" of" $total
    mpv $COMMBASE/Commbase/mpv/Robinson-Crusoe/crusoe_anew_15_baldwin_64kb.mp3
   ;;
esac
